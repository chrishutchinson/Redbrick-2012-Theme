...
if($now < $lead_end)
{
	...
	<div class="content no-shadow no-margin w-500 " style="z-index:98;">
		...
		<div class="text w-500">
			...
			<?php $the_query = new WP_Query( 'cat=' . $more_category . '&posts_per_page=2' ); // Query category ID ?>
	...
	<div class="content no-shadow no-margin w-500">
		...
		<div class="text w-500">
			...
			<?php $the_query = new WP_Query( 'cat=' . $more_category . '&offset=2&posts_per_page=2' ); // Query category ID ?>
			<?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
				...
				<h2><a href="<?php echo $url ?>"><?php echo get_the_title() ?></a></h2>
...
<div class="blank-content w-1000 shadow" id="triple">	
	...
	$the_query = new WP_Query( 'cat=' . $triple_category . '&posts_per_page=3' ); // Query slider category ID
	$x = "1";
